...
public class RelacionesEj2 {
    ...
    public static void main(String[] args) {
        ...
        revolver.llenarRevoler();
        System.out.println(revolver);

        ArrayList<Jugador> jugadores = new ArrayList();
        System.out.println("Ingresemos la cantidad de jugadores");
        int cantidadJugadores = read.nextInt();
        ...
        for (int i = 1; i <= cantidadJugadores; i++) {
            ...
            System.out.println("Se creo jugadores  :" + jugador.getNombre());
        }
